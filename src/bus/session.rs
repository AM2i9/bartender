// This code was autogenerated with `dbus-codegen-rust -d org.freedesktop.DBus -p /org/freedesktop/DBus -o session.rs`, see https://github.com/diwic/dbus-rs
use dbus as dbus;
...
#[derive(Debug)]
pub struct OrgFreedesktopDBusActivatableServicesChanged {
}

impl arg::AppendAll for OrgFreedesktopDBusActivatableServicesChanged {
    fn append(&self, _: &mut arg::IterAppend) {
    }
}

impl arg::ReadAll for OrgFreedesktopDBusActivatableServicesChanged {
    fn read(_: &mut arg::Iter) -> Result<Self, arg::TypeMismatchError> {
        Ok(OrgFreedesktopDBusActivatableServicesChanged {
        })
    }
}

impl dbus::message::SignalArgs for OrgFreedesktopDBusActivatableServicesChanged {
...
pub trait OrgFreedesktopDBusProperties {
    fn get(&self, arg0: &str, arg1: &str) -> Result<arg::Variant<Box<dyn arg::RefArg + 'static>>, dbus::Error>;
    fn get_all(&self, arg0: &str) -> Result<arg::PropMap, dbus::Error>;
    fn set(&self, arg0: &str, arg1: &str, arg2: arg::Variant<Box<dyn arg::RefArg>>) -> Result<(), dbus::Error>;
}
...
impl<'a, T: blocking::BlockingSender, C: ::std::ops::Deref<Target=T>> OrgFreedesktopDBusProperties for blocking::Proxy<'a, C> {
    ...
    fn set(&self, arg0: &str, arg1: &str, arg2: arg::Variant<Box<dyn arg::RefArg>>) -> Result<(), dbus::Error> {
        self.method_call("org.freedesktop.DBus.Properties", "Set", (arg0, arg1, arg2, ))
    }
}
