// This code was autogenerated with `dbus-codegen-rust -d org.freedesktop.NetworkManager -p /org/freedesktop/NetworkManager/Devices/1 -o devices.rs --system-bus`, see https://github.com/diwic/dbus-rs
use dbus as dbus;
...
impl<'a, T: blocking::BlockingSender, C: ::std::ops::Deref<Target=T>> OrgFreedesktopNetworkManagerDeviceLoopback for blocking::Proxy<'a, C> {
}
